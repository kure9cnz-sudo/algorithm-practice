// Practice version generated from class048/Code01_PrefixSumMatrix.java.
...
public class Code01_PrefixSumMatrix {
	...
	class NumMatrix {
		...
		public int sumRegion(int a, int b, int c, int d) {
			throw new UnsupportedOperationException("TODO: implement sumRegion in practice module");
		}
