// Practice version generated from class073/Code04_LastStoneWeightII.java.
...
public class Code04_LastStoneWeightII {
	...
	public static int lastStoneWeightII(int[] nums) {
		throw new UnsupportedOperationException("TODO: implement lastStoneWeightII in practice module");
	}

	// 非负数组nums中，子序列累加和不超过t，但是最接近t的累加和是多少
	// 01背包问题(子集累加和尽量接近t) + 空间压缩
	public static int near(int[] nums, int t) {
		throw new UnsupportedOperationException("TODO: implement near in practice module");
	}
