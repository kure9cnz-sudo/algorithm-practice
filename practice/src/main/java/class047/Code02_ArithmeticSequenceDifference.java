// Practice version generated from class047/Code02_ArithmeticSequenceDifference.java.
...
public class Code02_ArithmeticSequenceDifference {
	...
	public static void set(int l, int r, int s, int e, int d) {
		throw new UnsupportedOperationException("TODO: implement set in practice module");
	}
