// Practice version generated from class050/Code06_Heaters.java.
...
public class Code06_Heaters {
	...
	public static int findRadius(int[] houses, int[] heaters) {
		throw new UnsupportedOperationException("TODO: implement findRadius in practice module");
	}
	...
	public static boolean best(int[] houses, int[] heaters, int i, int j) {
		throw new UnsupportedOperationException("TODO: implement best in practice module");
	}
